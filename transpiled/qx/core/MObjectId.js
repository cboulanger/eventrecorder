(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Mixin.define("qx.core.MObjectId", {
    ...
    members: {
       ...
       * Apply owner
       */
      _applyOwner: function _applyOwner(value, oldValue) {
       ...
       * Apply objectId
       */
      _applyObjectId: function _applyObjectId(value, oldValue) {
        if (!this.__changingOwner) {
       ...
       */
      _cascadeObjectIdChanges: function _cascadeObjectIdChanges() {
       ...
       */
      _createObject: function _createObject(id) {
       ...
       * @return {qx.core.Object?} the created object
       */
      _createObjectImpl: function _createObjectImpl(id) {
        return undefined;
      },
       ...
       */
      addOwnedObject: function addOwnedObject(obj, id) {
        if (!this.__ownedObjects) {
          this.__ownedObjects = {};
        }
       ...
       */
      removeOwnedObject: function removeOwnedObject(args) {
        if (!this.__ownedObjects) {
      ...
      __removeOwnedObjectImpl: function __removeOwnedObjectImpl(obj) {
        if (obj !== null) {
       ...
       * @return {Array}
       */
      getOwnedObjects: function getOwnedObjects() {
...
//# sourceMappingURL=MObjectId.js.map?dt=1544616856034